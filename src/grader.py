...
class Test_2(GradedTestCase):
    def setUp(self):
        ...
        self.multitask_net_with_sharing = submission.MultiTaskNet(944, 1683, 32, [96, 64], False, True)
        self.multitask_net_without_sharing = submission.MultiTaskNet(944, 1683, 32, [96, 64], False, False)
